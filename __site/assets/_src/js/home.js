function UpdateHomeLayout() {
  ...
  // alert("Window width <= 767");
    $('#posts-sticky ul > li a .post-details').removeClass('height-full-width');
    $('#posts-sticky ul > li a .post-details').addClass('height-auto');
  }
  if ($(window).width() >= 768) {
  ...
  // alert("Window width >= 768 + <= 991");
    $('#posts-sticky ul > li a .post-details').removeClass('height-auto');
    $('#posts-sticky ul > li a .post-details').addClass('height-full-width');
  }
  if ($(window).width() <= 991) {
  // alert("Window width <= 991");
    $('#posts-sticky ul > li a .post-details').removeClass('height-full-width');
    $('#posts-sticky ul > li a .post-details').removeClass('height-onehalf-width');
    $('#posts-sticky ul > li a .post-details').removeClass('height-half-width');
  }
  if ($(window).width() >= 992) {
  // alert("Window width >= 992");
    $('#posts-sticky ul > li a .post-details').removeClass('height-auto');

    $('#posts-sticky ul > li:nth-child(1) a .post-details').addClass('height-full-width');
    $('#posts-sticky ul > li:nth-child(2) a .post-details').addClass('height-full-width');
    $('#posts-sticky ul > li:nth-child(3) a .post-details').addClass('height-full-width');
    $('#posts-sticky ul > li:nth-child(4) a .post-details').addClass('height-onehalf-width');
    $('#posts-sticky ul > li:nth-child(5) a .post-details').addClass('height-half-width');
    $('#posts-sticky ul > li:nth-child(6) a .post-details').addClass('height-onehalf-width');
    $('#posts-sticky ul > li:nth-child(7) a .post-details').addClass('height-onehalf-width');
    $('#posts-sticky ul > li:nth-child(8) a .post-details').addClass('height-onehalf-width');
    $('#posts-sticky ul > li:nth-child(9) a .post-details').addClass('height-half-width');
  }
